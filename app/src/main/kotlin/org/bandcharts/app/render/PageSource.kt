package org.bandcharts.app.render
...
import org.bandcharts.app.ui.viewer.ContentRect
import org.bandcharts.music.ChartLayout
import org.bandcharts.music.ChartRow
import org.bandcharts.music.Song
...
import org.bandcharts.music.Transposer
...
class ChartPageSource(
    ...
    companion object {
        ...
        suspend fun open(
            ...
            val text = org.bandcharts.app.data.DocumentSources
                .readChartText(context.contentResolver, uri, song.kind)
                ?: return@withContext OpenResult.Failed(
                    org.bandcharts.app.data.DocumentSources
    ...
    suspend fun open(
        ...
        return when (song.kind) {
            ...
            FileKind.UNKNOWN -> OpenResult.Failed(
                "BandCharts does not recognise this kind of file.",
            )
        }
    }
}
