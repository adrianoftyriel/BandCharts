package org.bandcharts.app.diag
...
private fun share(context: Context, text: String) {
    val uri = runCatching {
        ...
        val file = File(directory, "bandcharts-log-${System.currentTimeMillis()}.txt")
        file.writeText(text)
    ...
    val send = Intent(Intent.ACTION_SEND).apply {
        ...
        putExtra(Intent.EXTRA_SUBJECT, "BandCharts diagnostic log")
