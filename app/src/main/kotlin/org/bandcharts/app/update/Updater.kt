...
import org.bandcharts.update.Checksums
import org.bandcharts.update.Release
import org.bandcharts.update.UpdateCheck
 ...
 * from becoming the BandCharts on somebody's phone. The consequence is worth
...
object Updater {
     ...
     */
    private const val USER_AGENT = "BandCharts-Updater"
    ...
    enum class InstallConflict {
         ...
         * BandChartss and one empty library.
         */
        DIFFERENT_PACKAGE,
    }
