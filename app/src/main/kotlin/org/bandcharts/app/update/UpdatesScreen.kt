package org.bandcharts.app.update
...
import org.bandcharts.update.AvailableUpdate
import org.bandcharts.update.UpdateChannel
import org.bandcharts.update.UpdateStatus
...
fun UpdatesScreen(
    ...
    Column(
        ...
        Column(
            ...
            Body(
                controller.currentTag?.let { "BandCharts $versionName, from release $it" }
                    ?: "BandCharts $versionName. This build did not come from a release, " +
            ...
            if (!controller.canUpdateThisBuild) {
                Notice(
                    "This is a debug build, and it installs under a different name than the " +
                        ...
                        "of BandCharts rather than update this one, so the button is off.",
                )
            }
        ...
        when (controller.phase) {
            ...
            UpdatePhase.READY -> {
                ...
                if (controller.canInstall()) {
                    ...
                    Text(
                        "Android needs your permission for BandCharts to install an app. " +
            ...
            Updater.InstallConflict.DIFFERENT_SIGNER -> {
                ...
                Text(
                    "It was signed with a different key than the build already on this " +
                        ...
                        "package\".\n\n" +
                        "The only way through is to uninstall BandCharts first and install " +
            ...
            Updater.InstallConflict.DIFFERENT_PACKAGE -> {
                ...
                Text(
                    "It carries a different application id than the copy running now, so " +
                        ...
                        "you would have two BandChartss and one empty library.",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onErrorContainer,
                )
            }
