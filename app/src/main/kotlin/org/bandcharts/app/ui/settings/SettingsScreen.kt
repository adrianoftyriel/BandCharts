package org.bandcharts.app.ui.settings
...
import org.bandcharts.app.data.ThemeChoice
...
import org.bandcharts.app.ui.common.SettingRow
...
fun SettingsScreen(
    ...
    Column(
        ...
        Column(Modifier.verticalScroll(rememberScrollState())) {
            ...
            Text(
                releaseTag?.let { "BandCharts $versionName - release $it" }
                    ?: "BandCharts $versionName - built from source",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
                modifier = Modifier.padding(horizontal = 16.dp),
            )
