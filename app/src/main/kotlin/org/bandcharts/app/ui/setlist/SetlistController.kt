package org.bandcharts.app.ui.setlist
...
import org.bandcharts.library.SetlistBundle
...
class SetlistController(
    ...
    fun import(uri: Uri) {
        scope.launch {
            ...
            if (bundle == null) {
                importMessage = "That does not look like a BandCharts set list."
                return@launch
            }
            if (!SetlistCodec.canRead(bundle)) {
                importMessage = "That set list was made by a newer version of BandCharts. " +
