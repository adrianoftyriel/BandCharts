package org.bandcharts.app.net
...
import org.bandcharts.app.diag.Area
import org.bandcharts.app.diag.Diagnostics
import org.bandcharts.session.BackstageReport
import org.bandcharts.session.CheckReport
import org.bandcharts.session.CheckRequest
import org.bandcharts.session.FollowerEvent
import org.bandcharts.session.FollowerMachine
import org.bandcharts.session.FollowerState
import org.bandcharts.session.FollowerStatus
import org.bandcharts.session.Goodbye
import org.bandcharts.session.Hello
import org.bandcharts.session.LinkState
import org.bandcharts.session.Message
import org.bandcharts.session.Ping
import org.bandcharts.session.Pong
import org.bandcharts.session.Position
import org.bandcharts.session.AggregatedChart
import org.bandcharts.session.Catalogue
import org.bandcharts.session.CatalogueDevice
import org.bandcharts.session.CatalogueGone
import org.bandcharts.session.CataloguePeer
import org.bandcharts.session.CataloguePublish
import org.bandcharts.session.ChartOffer
import org.bandcharts.session.ChartWant
import org.bandcharts.session.ChartsOffered
import org.bandcharts.session.ChartsWanted
import org.bandcharts.session.SetlistPush
import org.bandcharts.session.Welcome
import org.bandcharts.session.Wire
import org.bandcharts.session.FollowerEffect
import org.bandcharts.session.LocalPosition
        ...
        for (effect in transition.effects) {
            if (effect is FollowerEffect.ReportStatus) {
                val status = FollowerStatus(
                    ...
                    deviceId = deviceId,
                    deviceName = deviceName,
                    following = transition.state.mode == org.bandcharts.session.FollowMode.FOLLOWING,
