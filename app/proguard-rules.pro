...
-keepclassmembers class org.bandcharts.** {
    *** Companion;
}
-keepclasseswithmembers class org.bandcharts.** {
    kotlinx.serialization.KSerializer serializer(...);
}
-keep,includedescriptorclasses class org.bandcharts.**$$serializer { *; }
...
# org.bandcharts it pins a Companion *field* on classes that have nothing to do
...
-keep class org.bandcharts.music.** { *; }
-keep class org.bandcharts.library.** { *; }
...
-keep class org.bandcharts.session.** { *; }
